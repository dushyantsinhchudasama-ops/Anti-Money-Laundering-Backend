...
class ForcedPasswordResetIntegrationTest {
    ...
    void fullForcedPasswordResetFlow() throws Exception {
        ...
        MvcResult createResult = mockMvc.perform(post("/api/v1/admin/tenants/" + hdfcTenant.getTenantId() + "/users")
        ...
        loginRequest.setTenantCode("HDFC");
        ...
        // Step 3: Operational Endpoint Attempt before Reset -> Blocked with 428 Precondition Required
        ...
        // Step 6: Operational Endpoint Attempt after Reset -> Not blocked by 428 (returns 404 for non-existent batch)
        mockMvc.perform(get("/api/v1/bank/batches/" + UUID.randomUUID())
        ...
        subsequentLoginRequest.setTenantCode("HDFC");
        ...
        JsonNode subsequentLoginResponse = objectMapper.readTree(subsequentLoginResult.getResponse().getContentAsString());
